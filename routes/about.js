...
router.get('/', (req, res) =>{
    ...
    var option = {}
    if(req.isAuthenticated()) { option ={ css : '<link rel="stylesheet" href="css/aboutus/aboutus.css">', // tham số cho css
    ...
    else {option = { css : '<link rel="stylesheet" href="css/aboutus/aboutus.css">', // tham số cho css
                    script: '<script src="js/public/sticknav.js"></script>', // tham số cho js
                    layout : 'layouts/layoutA', // tham số cho layout nào đc sử dụng
                    authStatus: 0 ,
                    username: ""}}
    res.locals.user = req.user;
    res.render('about_page/about', option)
})
